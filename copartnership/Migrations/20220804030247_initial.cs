        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartnerDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ParnerDuration = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    userid = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StatusId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_parnerForms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_parnerForms_orderStatuses_StatusId",
                        column: x => x.StatusId,
